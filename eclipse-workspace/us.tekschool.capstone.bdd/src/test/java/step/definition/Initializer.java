...
/* In Initializer class we will write or define our beforeHooks and afterHooks method and they are both
*coming from io.cucumber class
* @Before = When we add the @Before annotation on top of our beforHooks method, this method

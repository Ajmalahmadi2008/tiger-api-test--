...
public void i_click_on_login_button() {
	singleloginpageObj.clickOnLoginButton(); 
}

@Then("I logged into the Tekschool retail page")
public void i_logged_into_the_tekschool_retail_page() {
